            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  ...
                  <p className="text">Cần hỗ trợ liên hệ với chúng tôi: <span><a href="tel:123456789">0357732219</a></span></p>
                </div>
                {/* End Single Widget */}
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer social">
                  ...
                  <div className="contact">
                    <ul>
                      <li>509 Phan Đình Phùng, TP Quảng Ngãi</li>
                      <li>Nhóm 01</li>
                      <li>tplip18@pdu.edu.vn</li>
                      <li>0357732219</li>
                    </ul>
                  </div>
                  {/* End Single Widget */}
              ...
              <div className="row">
                <div className="col-lg-12 col-12">
                  <div className="text-center">
                    <p>Copyright &copy; 2023 By Nhóm 01</p>
                  </div>
                </div>
